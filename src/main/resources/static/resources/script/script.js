...
function getAuthenticationToken(){
    let endPoint = `http://localhost:7073/api/account`;
    let payload = {
        "username": "ferdy",
        "password": "indocyber",
...
function getProductInfo(id){
    let endPoint = `http://localhost:7073/api/merch/${id}/info`;
...
function getProductDetail(id){
    let endPoint = `http://localhost:7073/api/shop/${id}/info`;
...
function addBalance(dto){
    let endPoint = `http://localhost:7073/api/profile/add-balance`;
